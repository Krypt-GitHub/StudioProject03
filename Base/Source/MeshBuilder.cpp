...
Mesh* MeshBuilder::GenerateWater(const std::string &meshName, Color color, float lengthX, float lengthY)
{
...
Mesh* MeshBuilder::GenerateOBB(const std::string &meshName, Color color, float length)
{
	Vertex v;
	std::vector<Vertex> vertex_buffer_data;
